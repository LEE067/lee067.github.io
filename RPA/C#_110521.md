...
- void 는 Object형식과 동일 (들어오는 형식에 따라 바뀐다.)
- string => Replace와 Split 활용 문자열 추출

```c#
static void Main(string[] args)
        {
            string data = "atesta123a789a111";
            ...
            {
                Console.WriteLine(spdata[i]); //i = 0일때 공백출력
            }
...
![](C:\lee067.github.io-main\img\C#_110521_img.png)
